  ...
  public class SetEarthAnchorPoint : TwinLandComponent
  {
    ...
    public SetEarthAnchorPoint()
      : base("SetEarthAnchorPoint", "setEAP",
        "SetEarthAnchorPoint base on latitude and longitude ", "GIS tools")
    {
    }
    ...
    {
      pManager.AddBooleanParameter("Set", "set", "Set rhino's Earth Anchor Point", GH_ParamAccess.item);
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
      ...
      if (set)
      {
        ...
        //check if the earth anchor point has been set and its value
        if (!RhinoDoc.ActiveDoc.EarthAnchorPoint.EarthLocationIsSet())
        {
          res = "The Earth Anchor Point has not been updated yet";
