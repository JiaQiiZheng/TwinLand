    ...
    public class ImportVector : TwinLandComponent
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            for (int iLayer = 0; iLayer < dataSource.GetLayerCount(); iLayer++)
            {
                ...
                Transform sourceToModelSRSTransform = TwinLand.Convert.GetUserSRSToModelTransform(sourceSRS);
                Transform modelToSourceSRSTransform = TwinLand.Convert.GetModelToUserSRSTransform(sourceSRS);
                ...
                Point3d extPTmin = TwinLand.Convert.OgrPointToPoint3d(extMinSourceOgr, sourceToModelSRSTransform);
                Point3d extPTmax = TwinLand.Convert.OgrPointToPoint3d(extMaxSourceOgr, sourceToModelSRSTransform);
                ...
                Point3d extPTminUser = TwinLand.Convert.OgrPointToPoint3d(extMinSourceOgr, userSRSToModelTransform);
                Point3d extPTmaxUser = TwinLand.Convert.OgrPointToPoint3d(extMaxSourceOgr, userSRSToModelTransform);
                ...
                for (int i = 0; i < boundary.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        //OSGeo.OGR.Geometry ebbox = TwinLand.Convert.CurveToOgrPolygon(boundary[i]);
                        ...
                        while ((feat = clipped_layer.GetNextFeature()) != null)
                        {
                            ...
                            if (feat.GetGeometryRef() != null)
                            {
                                ...
                                gGoo.AppendRange(TwinLand.Convert.OgrGeomToGHGoo(geomUser, userSRSToModelTransform), new GH_Path(i, iLayer, m));
                                ...
                                for (int gpc = 0; gpc < geom.GetPointCount(); gpc++)
                                {
                                    ...
                                    pt3D.Transform(TwinLand.Convert.WGSToXYZTransform());
        ...
        {
            get { return new Guid("{a2e6e5fa-4905-48f7-aff3-dd5464e34e73}"); }
        }
    }
}
